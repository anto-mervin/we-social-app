...
export default function PostCardCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setVounter_name(initialValues.Vounter_name);
    setVounter_pic(initialValues.vounter_pic);
    setFund_needed(initialValues.fund_needed);
    setPreview_img(initialValues.Preview_img);
    setTotalUpvotes(initialValues.TotalUpvotes);
    setTitle(initialValues.Title);
    setDesp(initialValues.desp);
    setM1(initialValues.m1);
    setLocation(initialValues.Location);
    setM2(initialValues.m2);
    setM3(initialValues.m3);
    setM4(initialValues.m4);
    setM5(initialValues.m5);
    setM6(initialValues.m6);
    setM7(initialValues.m7);
    setM8(initialValues.m8);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PostCard(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PostCardCreateForm")}
      {...rest}
    >
      <TextField
        label="Vounter name"
